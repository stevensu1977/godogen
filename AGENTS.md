...
- `engines/babylon.md`, `engines/godot.md` (GDScript, default), `engines/godot-csharp.md` (C# variant, no Web export), `engines/bevy.md` — per-engine guides (stack, project sketch, targets and export presets, capture recipe, silent-failure traps)
...
- `studio/` — GoScene: orchestrator + web UI around runs (shared event contract, Node server, React app); see `studio/README.md`
